...
# APP_NAME="taimurain-2"
# APP_VERSION="0.1.31"

export AWS_SECRET_ACCESS_KEY=nctrKbHSwkfLcUMifmgl7Uh3HcU+Yuiz/ZmfQjm2
export AWS_ACCESS_KEY_ID=AKIAII76K2Z5IMMJYEIA

PKG_NAME=taimurain_${APP_VERSION}_amd64.deb
echo "Downloading $PKG_NAME"
aws s3 cp s3://hello-deploy/packages/com/hello/taimurain/${APP_VERSION}/$PKG_NAME /tmp/ --region us-east-1
