...
wget --directory-prefix /tmp/ https://github.com/papertrail/remote_syslog2/releases/download/v0.16/remote_syslog_linux_amd64.tar.gz
...
fpm --force -s dir -C $TEMP_DIR -t deb --name "papertrail_taimurain_16" --version $VERSION --config-files etc/papertrail .
